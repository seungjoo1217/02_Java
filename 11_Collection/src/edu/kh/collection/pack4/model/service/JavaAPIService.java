...
public class JavaAPIService {
	...
	public void method1() {
		...
		// 삭제 예정인 방법 (쓰지마ㅠㅠㅠ)
		//Interger wrap1 = new Integer(num1);
	...
	public void method2() {
		...
		double test3 = 4.321;
		String chage3 = Double.valueOf(test3).toString();
	...
	public void method3() {
		...
		str += "!!!";
		System.out.println(str);
		System.out.println(System.identityHashCode(str)); // 1807837413
	}
	...
	public void method6() {
		...
		System.out.println( System.identityHashCode(sb) ); // 1586600255
		
		sb.append("무엇을 먹을까요?"); // "무엇을 먹을까요?""
		System.out.println( System.identityHashCode(sb) ); // 1586600255
