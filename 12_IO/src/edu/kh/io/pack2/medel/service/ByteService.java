package edu.kh.io.pack2.medel.service;
...
public class ByteService {
	...
	public void fileByteOutput() {
		...
		try {
			// new FileOutputStrea("경로");
			// -> 경로에 작성된 파일과 연결된 파일 출력 시스템 객체 반영
	...
	public void bufferedFileByteOutput() {
		...
		/* BufferedOutputStream / BefferedInputStream
		 * 
