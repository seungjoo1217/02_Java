...
객체 지향 언어 : 객체 간 상호작용에 대한 개념을 컴퓨터로 옮겨놓은 것.

자바 객체 : 클래스에 정의된 내용대로 new 연산자를 통해 메모리 영역에 생성한 것

class : 설계도 같은 것. 객체의 속성과 기능에 대해 정의한 것.
...
캡슐화 원칙 : 1) 멤버변수에 대한 접근 권한은 private을 원칙으로 함.
				2) 멤버변수에 대한 연산처리를 목적으로 한 메서드는 클래스 내부에 작성함.
				3) 멤버 메서드는 클래스 밖에서 접근 가능하도록 public 으로 설정함.

메서드/기능의 정의란 : 해당 메서드가 어떤 기능을 수행/실행할 것인지 작성하는 것. (정의하는것)

메서드의 '호출'이란 : 정의된 메서드의 내용대로 수행/실행 할 수 있도록 메서드명을 부르는것.
