...
public class ClsService /*extends Student*/{
	...
	public void ex1() {
		...
		// (defalut) class인 TestVO는 import 불가(다른패키지)
	...
	public void ex2() {
		...
		// *** static이 붙은 ㅎ필드(변수)는 '클래스명/변수명' 으로 사용함 ***
		...
		**** 오버로딩 작성 규칙
		11. 메소드 이름이 동일해야 ㅎㄴ다
		2.매게변수의 자료형, 개수, 순서가 달라야한다.
		3. 리턴타입은 가탕도 되고, 달라도된다
		4. 매개변수명 신경쓰지 않음
		*/
	}
	...
	public void ex4() {
		...
		User u3 = new User("user03", "pass02", "김길동", 30, '남'); // 매개변수 5개 생성자(전부 초기화)
